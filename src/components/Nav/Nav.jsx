...
const MENU_STRUCTURE = [
  { label: "Home", href: "/", img: "/menu/homemenu.jpg" },
  {
    label: "About",
    img: "/menu/aboutmenu.png",
    submenus: [
      { label: "Chef Sanjay Patel", href: "/about/chef-sanjay-patel", img: "/menu/about/chefsanjoypatel.png" },
      { label: "Event gallery", href: "/about/event-gallery", img: "/menu/about/event.webp" },
      { label: "Star gallery", href: "/about/star-gallery", img: "/menu/about/star.png" },
    ],
  },
  {
    label: "Menu",
    img: "/menu/menu.webp",
    submenus: [
      { label: "Restaurant Menu", href: "/menu/restaurant", img: "/menu/menu/restaurant.webp" },
      { label: "Lunch Specials", href: "/menu/lunch", img: "/menu/menu/luncspecial.jpg" },
      { label: "Cocktail Menu", href: "/menu/cocktails", img: "/menu/menu/cocktails.jpg" },
      { label: "Food Truck Menu", href: "/menu/food-truck", img: "/menu/menu/foodtruck.jpeg" },
      { label: "Buffet", href: "/menu/buffet", img: "/menu/menu/buffet.jpg" },
      { label: "Catering Trays", href: "/menu/catering-trays", img: "/menu/menu/catering.jpg" },
      { label: "Wedding", href: "/menu/wedding", img: "/menu/menu/wedding.jpg" },
    ],
  },
  {
    label: "Services",
  ...
  {
    label: "Media",
    img: "/menu/media/media.jpg",
    submenus: [
      { label: "Blog", href: "/media/blog", img: "/menu/media/blog.jpg" },
      { label: "Press", href: "/media/press", img: "/menu/media/press.jpg" },
      { label: "Event", href: "/media/event", img: "/menu/media/event.jpg" },
      { label: "Specials", href: "/media/specials", img: "/menu/media/specials.jpg" },
    ],
  },
